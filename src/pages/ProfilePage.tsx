...
import { UserButton as ClerkUserButton, SignedIn as ClerkSignedIn, SignedOut as ClerkSignedOut, useClerk } from "@clerk/clerk-react";
import {
  CheckCircle2,
  Cloud,
  Download,
      ...
      <Card>
        ...
        <div className="mb-4 rounded-2xl border border-outline bg-slate-50 p-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <ClerkSignedOut>
              <button
                className="btn-secondary col-span-2 w-full justify-center gap-2 py-3"
                type="button"
                onClick={() => openSignIn({ redirectUrl: window.location.href, afterSignInUrl: window.location.href })}
              >
