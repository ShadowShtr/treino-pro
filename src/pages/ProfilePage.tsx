...
import { UserButton as ClerkUserButton, SignInButton as ClerkSignInButton, SignedIn as ClerkSignedIn, SignedOut as ClerkSignedOut } from "@clerk/clerk-react";
import {
  CheckCircle2,
  Cloud,
  Download,
          ...
          <div className="grid grid-cols-2 gap-2">
            <ClerkSignedIn>
              <div className="col-span-2 flex items-center gap-3 mb-2">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-semibold text-ink truncate">{syncStatus.userEmail ?? "—"}</p>
                  <p className="text-xs text-muted">Conta TREINO PRO</p>
                </div>
              </div>
              <button
            ...
            <ClerkSignedOut>
              <ClerkSignInButton mode="modal">
                <button className="btn-secondary col-span-2 w-full justify-center py-3 disabled:opacity-40" type="button" disabled={!syncStatus.configured}>
